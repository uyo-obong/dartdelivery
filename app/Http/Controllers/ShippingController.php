...
class ShippingController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.shippment.create_shippment', compact('shipments', 'types', 'transfers'));
    }
    ...
    public function  store(Request $request)
    {
        ...
        $addShipment = $request->only([
            ...
            'qty','transport_id','status', 'sender_email', 'receiver_postal'
        ]);
    ...
    public function updateShipment($id)
    {
        ...
        return view('admin.shippment.edit_shippment', compact('shipment', 'types', 'transfers'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $addShipment = $request->only([
            ...
            'shipper_city', 'shipper_state', 'shipper_country', 'receiver_firstN', 'receiver_lastN',
            'receiver_phone', 'receiver_address', 'receiver_city', 'receiver_state',
            'receiver_country', 'slug',  'type_id', 'weight',
            'qty','transport_id','status', 'sender_email', 'receiver_postal'
        ]);
...
//        dd($addShipment);
        ...
        Shipping::where('id', $id)->update($addShipment);
