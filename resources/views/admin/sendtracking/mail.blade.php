        ...
        <table cellspacing="0" cellpadding="0" class="force-full-width" bgcolor="#232925">
        	<tr>
        		<td class="computer-image">
        			...
        			<img style="display:block;" width="210" height="180" src="{{ $image }}" alt="Tracking">
        		</td>
        		<td style="color: #ffffff;" class="header-text">
        			<br>
        			<br>
        			<span style="font-size: 24px;">Hi! {{ $name }}, Good news!</span><br>
        			We would like to inform you that your order has shipped! copy your tracking number below.
        			<br>
        			<br>
        			<div>
        				<a href="{{ $url }}"
        				style="background-color:#007bff;color:#ffffff;display:inline-block;font-family:Helvetcia, sans-serif;font-size:16px;font-weight:light;line-height:40px;text-align:center;text-decoration:none;width:150px;-webkit-text-size-adjust:none;">Tracking Page</a>
        			...
        			<table cellspacing="0" cellpadding="0" class="force-full-width">
        				<tr>
        					...
        					<td style="text-align:right; vertical-align:top;">
        						<span class="header">Invoice: {{ $trackingId }}</span><br>
        				...
        				<tr>
                          ...
                          <div><!--[if mso]>
                            <v:rect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="http://" style="height:40px;v-text-anchor:middle;width:150px;" stroke="f" fillcolor="#2b934f">
                              ...
                              <![endif]-->
                              <a href="http://"
                              style="background-color:#007bff;color:#ffffff;display:inline-block;font-family:Helvetcia, sans-serif;font-size:16px;font-weight:light;line-height:40px;text-align:center;text-decoration:none;width:150px;-webkit-text-size-adjust:none;">{{ $trackingNo }}</a>
                              <!--[if mso]>
                                </center>
                              </v:rect>
                          <![endif]-->
