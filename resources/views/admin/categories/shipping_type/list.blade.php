            ...
            <div class="col-md-9">
                <div class="card offset-lg-3">
                    <div class="card-header">
                        <h4 class="card-title">Shipping Type List</h4>
                    </div>
                    <div class="card-body">
                            ...
                            <table id="legendary" class="table">
                                ...
                                @foreach($shippinglist as $shipping)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('editShipping', $shipping->id ) }}">
                                        ...
                                        <td>
                                            <form id="form-data-{{$shipping->id}}" class="remove" action='{{ route('destroyType', $shipping->id) }}' method='post' style="display: none;">
                                                {{csrf_field()}}
                                                {{method_field('DELETE')}}
            ...
            table.on('click', '.remove', function (e) {
                ...
                swalWithBootstrapButtons.fire({
                    ...
                    if (result.value) {
                        ...
                        document.getElementById('form-data-{{$shipping->id}}').submit();
                    }
